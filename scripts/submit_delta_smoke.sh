...
usage() {
  echo "Usage: ACCOUNT=<delta-account> bash scripts/submit_delta_smoke.sh"
  echo "   or: bash scripts/submit_delta_smoke.sh --account <delta-account>"
}
...
SBATCH_SCRIPT="${SBATCH_SCRIPT:-scripts/delta_smoke_qwen_0_5b.sbatch}"
