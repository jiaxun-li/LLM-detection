...
EXPORTS="ALL,RAID_RUN_ID=${RAID_RUN_ID},RAID_DATA_PATH=${RAID_DATA_PATH},NUM_SHARDS=${NUM_SHARDS},INDEX_CACHE_DIR=${INDEX_CACHE_DIR},REUSE_INDEX_PATH=${REUSE_INDEX_PATH},LIMIT_SOURCES=${LIMIT_SOURCES},BOOTSTRAP_REPETITIONS=${BOOTSTRAP_REPETITIONS},DEBUG_ONLY=${DEBUG_ONLY}"
